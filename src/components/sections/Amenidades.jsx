...
export default function Amenidades() {
	return (
        <>
		<Container className='px-[50px] md:px-[80px] lg:px-[120px] pt-[90px] md:pt-[140px] overflow-hidden relative max-w-[1320px]'>
			<Titulo>
        ...
        <DecoracionHorizontal className='w-full overflow-hidden' options={{className: 'inline'}} />
